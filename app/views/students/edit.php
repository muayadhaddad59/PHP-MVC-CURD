...
<div class="row">
    <div class="col-md-8 mx-auto">
        <div class="card bg-light mt-5">
            ...
            <div class="card-body">
                <form method="post" action="<?php echo URLROOT ;?>/Students/edit/<?php echo $data['id'] ;?>">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col">
                                <input type="submit" class="btn btn-primary btn-block pull-left" value="Update Student">
                            </div>
                        </div>
                    </div>
                </form>
